...
func (a *API) getMachine(vm *object.VirtualMachine) (*ESXMachine, error) {
	...
	deadline, _ := context.WithDeadline(ctx, time.Now().Add(1000*time.Second))
...
func (a *API) buildCloneSpec(baseVM *object.VirtualMachine, folder *object.Folder, network object.NetworkReference, resourcePool *object.ResourcePool, datastore *object.Datastore, ignitionData string) (*types.VirtualMachineCloneSpec, error) {
...
func (a *API) CreateDevice(name string, conf *conf.Conf) (*ESXMachine, error) {
	ignitionData := base64.StdEncoding.EncodeToString(conf.Bytes())
	...
	cloneSpec, err := a.buildCloneSpec(baseVM, folder, defaults.network, defaults.resourcePool, defaults.datastore, ignitionData)
	if err != nil {
	...
	err = a.updateOVFEnv(vm, ignitionData)
	if err != nil {
...
func (a *API) buildCreateImportSpecRequest(name string, flagOVAPath string, finder *find.Finder, defaultNetwork object.NetworkReference, resourcePool *object.ResourcePool, datastore *object.Datastore) (*archive, *types.OvfCreateImportSpecResult, error) {
...
func (a *API) updateOVFEnv(vm *object.VirtualMachine, ignitionData string) error {
