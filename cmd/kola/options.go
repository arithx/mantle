...
func init() {
	...
	sv(&kola.OpenStackOptions.Region, "openstack-region", "regionOne", "OpenStack region")
	...
	sv(&kola.OpenStackOptions.DomainID, "openstack-domain-id", "", "OpenStack domain id")
	sv(&kola.OpenStackOptions.FloatingIPPool, "openstack-floating-ip-pool", "", "(optional) OpenStack floating ip pool for Compute v2 networking")
	sv(&kola.OpenStackOptions.SecurityGroup, "openstack-security-group", "", "OpenStack security group")
