...
func init() {
	ESX.PersistentFlags().StringVar(&options.Server, "server", "", "ESX Server IP")
	ESX.PersistentFlags().StringVar(&options.User, "user", "", "ESX User")
	ESX.PersistentFlags().StringVar(&options.Password, "password", "", "ESX Password")
